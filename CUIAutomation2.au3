...
;module UIA_Patterns
Global Const $UIA_InvokePattern = 10000
Global Const $UIA_SelectionPattern = 10001
Global Const $UIA_ValuePattern = 10002
Global Const $UIA_RangeValuePattern = 10003
Global Const $UIA_ScrollPattern = 10004
Global Const $UIA_ExpandCollapsePattern = 10005
Global Const $UIA_GridPattern = 10006
Global Const $UIA_GridItemPattern = 10007
Global Const $UIA_MultipleViewPattern = 10008
Global Const $UIA_WindowPattern = 10009
Global Const $UIA_SelectionItemPattern = 10010
Global Const $UIA_DockPattern = 10011
Global Const $UIA_TablePattern = 10012
Global Const $UIA_TableItemPattern = 10013
Global Const $UIA_TextPattern = 10014
Global Const $UIA_TogglePattern = 10015
Global Const $UIA_TransformPattern = 10016
Global Const $UIA_ScrollItemPattern = 10017
Global Const $UIA_LegacyIAccessiblePattern = 10018
Global Const $UIA_ItemContainerPattern = 10019
Global Const $UIA_VirtualizedItemPattern = 10020
Global Const $UIA_SynchronizedInputPattern = 10021
...
;enum TreeScope
Global Const $TreeScope_Element = 1 ; Specifies that the search include the element itself.
Global Const $TreeScope_Children = 2 ; Specifies that the search include the element's immediate children.
Global Const $TreeScope_Descendants = 4 ; Specifies that the search include the element's descendants, including children.
Global Const $TreeScope_Parent = 8 ; Specifies that the search include the element's parent. Not supported.
Global Const $TreeScope_Ancestors = 16 ; Specifies that the search include the element's ancestors, including the parent. Not supported.
Global Const $TreeScope_Subtree = 7 ; Specifies that the search include the root of the search and all descendants.
...
Global $dtagIUIAutomationCacheRequest = "AddProperty hresult(int);" & _
...
Global $dtagIUIAutomationPropertyCondition = "propertyId hresult(int*);" & _
...
Global $dtagIUIAutomationAndCondition = "ChildCount hresult(int*);" & _
...
Global $dtagIUIAutomationOrCondition = "ChildCount hresult(int*);" & _
		"GetChildrenAsNativeArray hresult(ptr*;int*);" & _
		"GetChildren hresult(ptr*);"
...
Global $dtagIUIAutomationTreeWalker = "GetParentElement hresult(ptr;ptr*);" & _
...
Global $dtagIUIAutomationDockPattern = "SetDockPosition hresult(long);" & _
...
Global $dtagIUIAutomationExpandCollapsePattern = "Expand hresult();" & _
		"Collapse hresult();" & _
...
Global $dtagIUIAutomationGridPattern = "GetItem hresult(int;int;ptr*);" & _
...
Global $dtagIUIAutomationGridItemPattern = "CurrentContainingGrid hresult(ptr*);" & _
...
Global $dtagIUIAutomationMultipleViewPattern = "GetViewName hresult(int;bstr*);" & _
...
Global $dtagIUIAutomationRangeValuePattern = "SetValue hresult(ushort);" & _
...
Global $dtagIUIAutomationScrollPattern = "Scroll hresult(long;long);" & _
...
Global $dtagIUIAutomationSelectionPattern = "GetCurrentSelection hresult(ptr*);" & _
...
Global $dtagIUIAutomationSelectionItemPattern = "Select hresult();" & _
...
Global $dtagIUIAutomationSynchronizedInputPattern = "StartListening hresult(long);" & _
		"Cancel hresult();"

Global Const $sIID_IUIAutomationTablePattern = "{620E691C-EA96-4710-A850-754B24CE2417}"
Global $dtagIUIAutomationTablePattern = "GetCurrentRowHeaders hresult(ptr*);" & _
...
Global $dtagIUIAutomationTableItemPattern = "GetCurrentRowHeaderItems hresult(ptr*);" & _
...
Global $dtagIUIAutomationTogglePattern = "Toggle hresult();" & _
...
Global $dtagIUIAutomationValuePattern = "SetValue hresult(bstr);" & _
...
Global $dtagIUIAutomationTextRange = "Clone hresult(ptr*);" & _
...
Global $dtagIUIAutomationTextRangeArray = "Length hresult(int*);" & _
		"GetElement hresult(int;ptr*);"

Global Const $sIID_IUIAutomationTextPattern = "{32EBA289-3583-42C9-9C59-3B6D9A1E9B6A}"
Global $dtagIUIAutomationTextPattern = "RangeFromPoint hresult(struct;ptr*);" & _
...
Global $dtagIUIAutomationLegacyIAccessiblePattern = "Select hresult(long);" & _
...
Global $dtagIUIAutomationProxyFactory = "CreateProvider hresult(hwnd;long;long;ptr*);" & _
		"ProxyFactoryId hresult(bstr*);"

Global Const $sIID_IRawElementProviderSimple = "{D6DD68D1-86FD-4332-8666-9ABEDEA2D24C}"
Global $dtagIRawElementProviderSimple = "ProviderOptions hresult(long*);" & _
...
Global $dtagIUIAutomationProxyFactoryEntry = "ProxyFactory hresult(ptr*);" & _
...
Global $dtagIUIAutomationProxyFactoryMapping = "count hresult(uint*);" & _
